...
namespace Query {
    ...
    public partial class Where {
        ...
        /// <summary>
        /// Query helper for member Where.AssetFolder
        /// </summary>
        [System.CLSCompliantAttribute(false)]
        public static Root_Query_AssetFolder AssetFolder {
            get {
                return new Root_Query_AssetFolder();
            }
        }
        
        /// <summary>
        /// Query helper for member Where.Query_AssetFolder
        /// </summary>
        [System.CLSCompliantAttribute(false)]
        public partial class Query_AssetFolder<T1> : QueryBuilder<T1>
         {
            
            /// <summary>
            /// Query helper for member Query_AssetFolder..ctor
            /// </summary>
            public Query_AssetFolder() : 
                    this(null, "this", null) {
            }
            ...
            /// Query helper for member Query_AssetFolder..ctor
            /// </summary>
            public Query_AssetFolder(QueryBuilder<T1> parent, string name, string associationPath) : 
            ...
            /// Query helper for member Query_AssetFolder..ctor
            /// </summary>
            public Query_AssetFolder(QueryBuilder<T1> parent, string name, string associationPath, bool backTrackAssociationOnEquality) : 
                    base(parent, name, associationPath, backTrackAssociationOnEquality) {
            }
            
            /// <summary>
            /// Query helper for member Query_AssetFolder.
            /// </summary>
            ...
            /// Query helper for member Query_AssetFolder.
            /// </summary>
            public virtual Query_AssetFolder<T1> ParentFolder {
                get {
                    string temp = associationPath;
                    temp = ((temp + ".") 
                                + "ParentFolder");
                    Query_AssetFolder<T1> child = new Query_AssetFolder<T1>(null, "ParentFolder", temp, true);
                    child.ShouldSkipJoinOnIdEquality = this.ShouldSkipJoinOnIdEquality;
                    return child;
                }
            }
        ...
        /// <summary>
        /// Query helper for member Where.Root_Query_AssetFolder
        /// </summary>
        [System.CLSCompliantAttribute(false)]
        public partial class Root_Query_AssetFolder : Query_AssetFolder<Membrane.Models.AssetManagement.AssetFolder> {
        }
    }
    ...
    public partial class OrderBy {
        ...
        /// <summary>
        /// Query helper for member OrderBy.AssetFolder
        /// </summary>
        [System.CLSCompliantAttribute(false)]
        public partial class AssetFolder {
            
            /// <summary>
            /// Query helper for member AssetFolder.Name
            /// </summary>
            ...
            /// <summary>
            /// Query helper for member AssetFolder.IsDeleted
            /// </summary>
            ...
            /// <summary>
            /// Query helper for member AssetFolder.Id
            /// </summary>
    ...
    public partial class ProjectBy {
        ...
        /// <summary>
        /// Query helper for member ProjectBy.AssetFolder
        /// </summary>
        [System.CLSCompliantAttribute(false)]
        public partial class AssetFolder {
    ...
    public partial class GroupBy {
        ...
        /// <summary>
        /// Query helper for member GroupBy.AssetFolder
        /// </summary>
        [System.CLSCompliantAttribute(false)]
        public partial class AssetFolder {
